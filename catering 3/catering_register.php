...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  if ( empty( $errors ) )
  {
    ...
    if ( mysqli_num_rows( $r ) != 0 ) $errors[] = 'Email address already registered. <a href="catering_login.php">Login</a>' ;
  }
  ...
  if ( empty( $errors ) ) 
  {
    ...
    $r = @mysqli_query ( $dbc, $q ) ;
    if ($r)
    { echo '<h1>Registered!</h1><p>You are now registered.</p><p><a href="catering_login.php">Login</a></p>'; }
...
<h1>Register</h1>
<form action="catering_register.php" method="post">
