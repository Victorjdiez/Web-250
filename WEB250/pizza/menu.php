...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
  <div class="w3-content">
    ...
    <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">THE MENU</h1>
     ...
     <?php 
     $specialItemOne = "Bruchetta Pizza (15 inch)";
     $specialItemTwo = "Shrimp Cocktail (10 piece)";
     

     $current_special= "One Starter And One Entree";
     $itemOnePrice = 20.00;
     $itemTwoPrice = 14.00;
     $discount = .15;
     $discounted_special_price = ($itemOnePrice + $itemTwoPrice) - $discount * ($itemOnePrice + $itemTwoPrice) ; 



     echo "<h1><br> Daily Sepcial: $current_special</h1>";
     echo "<h1><br>Today: $specialItemOne and $specialItemTwo </h1>";
     
     echo "<h1><br>Discount: $discount %</h1>";
     echo "<h1><br> Original Price: $ ". $itemOnePrice + $itemTwoPrice . " </h1>";
     echo "<h1><br> Discounted Price: $ " .number_format($discounted_special_price,2). " </h1>";
