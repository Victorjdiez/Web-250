     ...
     *******************************************
     ...
     <?php 
      ...
      if(isset($_GET['total']) && ($_GET['total'] > 0) && (!empty($_SESSION['cart']))) {
        ...
        $q = "INSERT INTO orders(user_id, total, order_date) VALUES (1, " .
        $_GET['total'] . ", Now())";
        ...
        // Store order contents in order_contents database table.
          ...
          price) VALUES ($order_id, " . $row['item_id'] . "," . $_SESSION['cart']
          [$row['item_id']]['quantity'] . "," . $_SESSION['cart'][$row['item_id']]['price'] .
          ")";
        ...
        echo "<p>Thanks for your order. Your Order Number Is #" . $order_id .
        "</p>";
        // Remove cart items.
        $_SESSION['cart'] = NULL;
      } else {
