...
<div class="w3-main" style="margin-left:250px">
 ...
 <div class="w3-row w3-grayscale">
   ...
   <! --- 
     *******************************************
     IMPLEMENT YOUR PHP HERE 2024 , leave this comment in your code, start php tag below this comment.
     **** NOTE I have use the lines given below rather than the lines 50 adn 51 from video, 
     **** so keep this version of $sql and mysqli_query and replace those lines from video
